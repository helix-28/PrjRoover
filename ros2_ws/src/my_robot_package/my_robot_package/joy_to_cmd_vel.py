...
class JoystickToCmdVel(Node):
    ...
    def timer_callback(self):
        ...
        # Appel de la fonction direction_mecanum pour contrôler les moteurs
        direction_mecanum(vitesse, angle + 180, rotation * -100)  # Utilise la fonction direction_mecanum
